...
public SysUser(Integer sysuserId, String password) {
    ...
    public SysUser(String username, String password, boolean isActive, String firstName, String lastName, String emailAdd, String contactNo, String nicNo, String dob, Date addedDate, Integer addedBy, Date lastUpdatedDate, Integer lastUpdatedBy, UserGroup userGroupId, Company company) {
