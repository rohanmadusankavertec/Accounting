...
//                Branch b= new Branch(1);
                ...
                SysUser sysUser = new SysUser(username, encryptPassword, true, firstName, lastName, email, contactNo, nicNo, dob, date, userId, date, userId, group,company);
            ...
            case "CreateUG": {//add new user group
