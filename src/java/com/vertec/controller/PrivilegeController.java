...
public class PrivilegeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (action) {
            case "ViewPrivilege": { // load privilage page 
            ...
            case "SavePrivilege": { // save privilage 
            ...
            case "UpdatePrivilege": { // update privilege
            ...
            case "LoadUserGroups": { //load user group  page
            ...
            case "LoadUserGroupsForPI": { //load user group 
                List<UserGroup> ugList = privilegeDAOImpl.loadAllUserGroup(company);
                request.setAttribute("ugList", ugList);
            ...
            case "SetPrivilege": {//get the  privilage 
            ...
            case "SetPrivilegeItem": { // get the privilage items according to the group
                String groupId = request.getParameter("groupId").trim();
                int group = Integer.parseInt(groupId);
...
//                }
            ...
            case "UpdatePriviledge": { // update privilage
                String dataArr = request.getParameter("dataArr").trim();
...
//                List<Integer> newAr = new ArrayList<Integer>();
            ...
            case "UpdatePriviledgeItem": {// update privilage items
                String dataArr = request.getParameter("dataArr").trim();
                String arr[] = dataArr.split(",");
                int length = arr.length;
                int ugId = 0;
...
//                List<Integer> newAr = new ArrayList<Integer>();
            ...
            case "ForPrivilegeItem": { // load add prilage item 
            ...
            case "SavePI": {// savae privilage items
            ...
            case "ViewPI": { // view privilage item
            ...
            case "SaveUpdatedPI": { // update privilage item 
