...
public class LoanPayController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            switch(action){
                case "loadLoanPayPage":{ // load loan pay page
                ...
                case "loadLoanAccount":{ // load account on slect element
                ...
                case "loadPayType":{ // load account on slect element
                ...
                case "loadLoan":{ // get the loan details
...
//                    System.out.println(payType);
                ...
                case "saveLoanPayment":{ // save the loan payment 
...
//                    t.setAmount(Double.parseDouble(amount));
    ...
    //                    t.setAmount(Double.parseDouble(amount));
                ...
                case"loadLoanById":{ // get the loan 
                    String lId = request.getParameter("loanId").trim();
