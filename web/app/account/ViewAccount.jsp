...
<script type="text/javascript">
    ...
    function loadToUpdate(){ // load to sub type to update 
...
//            
//            type: 'POST',
//            url: "Account?action=loadToUpdate&accountId="+id,
//            
//            success:function (msg){
//                
//                var reply = eval('('+msg+')');
//                document.getElementById("subType").value=reply.subType;
//                document.getElementById("Type").value=reply.Type;
//            }            
//            
//        });
//    }
