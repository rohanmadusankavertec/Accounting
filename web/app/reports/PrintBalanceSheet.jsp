            ...
            <div style="width: 100%;">
                <table style="width: 100%;">
                    ...
                    <%
                        ...
                        if(dd.getDepreciation().getAmount() !=null){
                            depreamount=dd.getDepreciation().getAmount();
                        }
                        if(dd.getAmount() !=null){
                            damount=dd.getAmount();
                        }
                        if(dd.getBeforedep() !=null){
                            Beforedep=dd.getBeforedep();
                        }
                            
                            
                            
                        Assets+=depreamount-damount-Beforedep;
