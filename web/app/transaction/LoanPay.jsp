...
<script type="text/javascript">
    ...
    function loadAccount() { // load account on select element
    ...
    function loadAcconutByPayType(){ // load account on select element
    ...
    var paid = "";
    function loadLoan(){ // load account on select element
    ...
    function SaveLoan() { // send the data to contraller classs to  save 
    ...
    function loadLoanById(){// load amount on element
//        alert("aaaa");
