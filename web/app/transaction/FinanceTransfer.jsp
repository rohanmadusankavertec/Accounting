...
<script type="text/javascript">
    ...
    function loadDebitAcc(){ // load debit account on select element
    ...
    function loadCreditAcc(){ // load credit account on select element
    ...
    function SaveFinanceTransfer() { // send the data to contraller classs to  save 
