...
//    }
    ...
    function SaveLiability() {// send the data to contraller classs to  save 
    ...
    function calculatePayable() { // calculation of payment 
    ...
    function caltotalPayable() { // calculation with interest 
        var itype = document.getElementById("itype").value;
        var iterm = document.getElementById("iterm").value;
