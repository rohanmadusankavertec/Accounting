...
<script type="text/javascript">
    ...
    function LoadSecontAccounts() {//  load account on select element
    ...
    function calculatediscount() { // calculate the descount
    ...
    function setPaidAmount() { // calculate the pament show and hide feild
        //check for - discount
        calculatediscount();
    ...
    function SavePurchase() {// send the data to contraller classs to  save 
        calculatediscount();
