...
<script type="text/javascript">
    ...
    function LoadSecontAccounts() { // load accout on select element
    ...
    function SaveLiability() {// send the data to contraller classs to  save liabilities
    ...
    function calculatePayable() { // calculate loan payment
    ...
    function caltotalPayable() { // calculate loan with interest
        var itype = document.getElementById("itype").value;
        var iterm = document.getElementById("iterm").value;
